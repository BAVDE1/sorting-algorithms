...
def get_collection(game, sorter: Sorter) -> Collection:
    ...
    method_collection.add_buttons([
        ...
        Button(SortingMethods.MERGE, pg.Vector2(5, 65), BTNOperation(function=sorter.change_sorting_method, method=SortingMethods.MERGE), colour=col, text_size=size),
        ...
        Button(SortingMethods.RADIX, pg.Vector2(5, 155), BTNOperation(function=sorter.change_sorting_method, method=SortingMethods.RADIX), colour=col, text_size=size)
    ])
